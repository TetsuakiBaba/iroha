...
|---|---:|---:|---:|---:|---:|---:|
| realpersonachat | 408,619 | 362,406 | 400,040 | 388,202 | 431,424 | 819,626 |
| mrmp | 100,680 | 75,072 | 67,764 | 59,655 | 36,846 | 96,501 |
| jmrd | 114,750 | 48,304 | 47,127 | 41,692 | 44,958 | 86,650 |
| newschat | 11,256 | 5,008 | 6,860 | 6,062 | 9,607 | 15,669 |
| jcre3 | 2,652 | 1,637 | 1,534 | 1,400 | 1,338 | 2,738 |
| open2ch | 3,432,865（間引き後。全体 18,589,859） | 2,093,666 | 2,453,128 | 2,382,555 | 2,848,851 | 5,231,406 |
| 計 | 4,070,822 | 2,586,093 | 2,976,453 | 2,879,566 | 3,373,024 | 6,252,590 |

split は train 6,126,816 / validation 62,861 / test 62,913。同じ日に `build-typo-corpus.sh spoken` で最初から作り直し、
3 ファイルとも SHA-256 が一致した（取得済みの状態から約 14 分）。その後、testdata/iroha/typo のベンチを学習データと
重ならないように改訂したので、除外する読みが変わり、読み一覧を作り直した（上の数字は改訂版のベンチで除外したもの。
初版のベンチで除外していた 84 読みが学習に戻った）open2ch の除外の内訳（間引き後の 343 万投稿に対して）は
