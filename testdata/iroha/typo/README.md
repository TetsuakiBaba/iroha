...
../../../dataset/iroha-typo-normalizer/.venv/bin/python make_bench.py --corpus   # 作り直し + 検査（--corpus は学習コーパスとの重なり）
cd ../../..
...
- `--corpus`: 学習コーパス（dataset/iroha-typo-normalizer/data/typo-corpus）との重なり。
